...
_add(Lesson(
    ...
    definition=(
        ...
        "```\n\n"
        "Que se lee así:\n\n"
        "  · **FCF_t** = flujo de caja libre del año t (la plata "
        "real que la empresa puede sacar del negocio)\n"
        "  · **WACC** = costo promedio del capital (la tasa de "
        "descuento que refleja el riesgo)\n"
        "  · **N** = cantidad de años proyectados explícitamente "
        "(típico: 5 a 10)\n"
        "  · **TV** = valor terminal (todo lo que viene después "
        "del año N)\n\n"
        "El armado del DCF tiene 4 pasos:\n\n"
        "  1. **Proyectar el FCF** durante los próximos 5 a 10 años.\n"
        "  2. **Estimar el valor terminal**: lo que viene después "
        "del año 10. Fórmula clásica (Gordon growth):\n"
        "```\n"
        "         FCF_N+1 × (1+g)\n"
        "  TV = ──────────────────\n"
        "          WACC - g\n"
        "```\n"
        "  donde **g** es el crecimiento perpetuo (limitado al "
        "crecimiento de la economía, ~2-3%).\n\n"
        "  3. **Descontar todo al presente** usando el WACC.\n"
        "  4. **Restar la deuda neta y dividir por la cantidad de "
        "acciones**:\n"
        "```\n"
        "                  Valor empresa - Deuda neta\n"
        "  Precio justo = ─────────────────────────────\n"
        "                       Acciones en circulación\n"
        "```\n\n"
        "Si ese precio justo da más alto que el precio de mercado, "
        "en teoría la acción está barata. Si da más bajo, está cara."
    ),
    why_matters=(
    ...
    case_study=(
        "**Ejemplo numérico simplificado** (DCF de 5 años para una "
        "empresa que genera $100M de FCF este año, crece al 10% por "
        "5 años, después al 2.5% perpetuo, con WACC del 9%):\n\n"
        "```\n"
        "Año 1: FCF $110.0M / (1.09)^1 = $100.9M\n"
        "Año 2: FCF $121.0M / (1.09)^2 = $101.8M\n"
        "Año 3: FCF $133.1M / (1.09)^3 = $102.8M\n"
        "Año 4: FCF $146.4M / (1.09)^4 = $103.7M\n"
        "Año 5: FCF $161.1M / (1.09)^5 = $104.7M\n"
        "                              ─────────\n"
        "Suma de FCFs descontados:      $513.9M\n"
        "\n"
        "Terminal Value (Gordon):\n"
        "  TV = $161.1M × 1.025 / (0.09 - 0.025) = $2,541M\n"
        "  TV descontado = $2,541M / (1.09)^5    = $1,652M\n"
        "\n"
        "Valor empresa total: $513.9M + $1,652M = $2,166M\n"
        "```\n\n"
        "Notá algo: **el 76% del valor viene del Terminal Value** "
        "($1,652M de $2,166M). Por eso decimos que el DCF es muy "
        "sensible a las suposiciones de largo plazo.\n\n"
        "---\n\n"
